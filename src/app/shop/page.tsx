      ...
      <main className="pt-24 pb-16 px-4 max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-500 text-sm">{ownedCars.length}/{CAR_ITEMS.length} Autos gekauft</p>
          </div>
        ...
        <Link 
          href="/profile#garage"
          className="block mb-6 p-4 bg-gradient-to-r from-green-950/50 to-zinc-900 rounded-2xl border border-green-800/50 hover:border-green-600 transition-colors"
        >
          <p className="text-green-400 font-medium">💡 Gekaufte Autos kannst du in deinem Profil (Garage) auswählen!</p>
        </Link>
                ...
                <div className="p-4">
                  ...
                  {owned ? (
                    <div className="flex items-center justify-center gap-2 py-2.5 bg-green-900/30 rounded-xl text-green-400 font-medium">
                      <Check className="w-4 h-4" /> Im Besitz
                    </div>
                  ) : (
                    <button
                      onClick={() => buyCar(car)}
